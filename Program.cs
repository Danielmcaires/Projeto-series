...
namespace Projeto2_series
{
    class Program
    {
        ...
        private static void VisulaizarSerie()
        {
        ...
        {
            Console.WriteLine("Digite o id da série que será excluída: ");
            int indiceSerie = int.Parse(Console.ReadLine());

            Console.WriteLine("Tem certeza que deseja excluir a série #{0} ?(S/N)", indiceSerie);
